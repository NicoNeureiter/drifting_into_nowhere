...
# def parse_lgfam_node_label(node_label):
#     """Parse the label of a node in an lgfam Newick tree into name and different
#     language codes.
#
#     Args:
#         node_label (str): The lgfam node label taken from a Newick tree.
#
#     Returns:
#         dict:
#     """
...
if __name__ == '__main__':
    ...
    plot_hpd(tree, HPD)
    plot_tree(tree, lw=0, cmap=cmap, color_fun=get_edge_heights, no_arrow=False)  #, alpha_fun=flatten(get_edge_heights, 0.5))
